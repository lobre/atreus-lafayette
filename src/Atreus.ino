...
KEYMAPS(
  ...
  (
    ...
    Key_Esc,  Key_Tab,  Key_LeftGui,  Key_LeftAlt,  Key_Space,  Key_LeftControl,

                    Key_Y,          Key_U,         Key_I,      Key_O,       Key_P,
                    Key_H,          Key_J,         Key_K,      Key_L,       Key_Semicolon,
    Key_Backslash,  Key_N,          Key_M,         Key_Comma,  Key_Period,  Key_Slash,
    Key_LeftShift,  Key_Backspace,  M(MACRO_SYM),  Key_Minus,  Key_Quote,   Key_Enter
  ),
  ...
  (
    ...
    Key_Tilde,             Key_Backtick,     Key_Bar,           Key_Underscore,         Key_Slash,    XXX,
    ...
    XXX,            Key_Backslash,  Key_At,       Key_Hash,      Key_Exclamation,  M(MACRO_NN),
    Key_LeftShift,  Key_Backspace,  TD(TD_BASE),  XXX,           XXX,              Key_Enter
  ),

  [NN] = KEYMAP_STACKED
  (
    Key_Esc,        Key_Home,       Key_UpArrow,    Key_End,         Key_PageUp,
    Key_Insert,     Key_LeftArrow,  Key_DownArrow,  Key_RightArrow,  Key_PageDown,
  ...
  [FN] = KEYMAP_STACKED
  (
    XXX,      Consumer_DisplayBrightnessDecrement,  Consumer_VolumeIncrement,  Consumer_DisplayBrightnessIncrement,  XXX,
    ...
    Key_LeftShift,  Key_Backspace,  TD(TD_BASE),  Key_PrintScreen,  Key_ScrollLock,  Key_Enter
  )
)
